...
def get_any_commnd():
    ...
    command = 'bash scripts/dist_train_debug.sh 4 --cfg_file ./cfgs/nuscenes_models/unitr+lss+selfmamba3_o.yaml --sync_bn --logger_iter_interval 100 --pretrained_model /home/hswang/AD/Fusion/UniTR2/ckpts/unitr_pretrain.pth --extra_tag self_and_cross_with_4d_dwconv_epo10_merge2_2'
